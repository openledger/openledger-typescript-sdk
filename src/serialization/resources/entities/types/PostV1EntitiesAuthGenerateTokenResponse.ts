...
export const PostV1EntitiesAuthGenerateTokenResponse: core.serialization.ObjectSchema<
    serializers.PostV1EntitiesAuthGenerateTokenResponse.Raw,
    OpenLedgerClient.PostV1EntitiesAuthGenerateTokenResponse
...
export declare namespace PostV1EntitiesAuthGenerateTokenResponse {
