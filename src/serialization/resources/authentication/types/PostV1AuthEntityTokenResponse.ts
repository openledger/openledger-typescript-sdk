...
export const PostV1AuthEntityTokenResponse: core.serialization.ObjectSchema<
    serializers.PostV1AuthEntityTokenResponse.Raw,
    OpenLedgerClient.PostV1AuthEntityTokenResponse
...
export declare namespace PostV1AuthEntityTokenResponse {
