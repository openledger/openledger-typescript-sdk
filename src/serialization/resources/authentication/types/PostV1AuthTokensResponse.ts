...
export const PostV1AuthTokensResponse: core.serialization.ObjectSchema<
    serializers.PostV1AuthTokensResponse.Raw,
    OpenLedgerClient.PostV1AuthTokensResponse
...
export declare namespace PostV1AuthTokensResponse {
