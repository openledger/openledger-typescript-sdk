...
export const PostV1DevelopersAuthGenerateTokenResponse: core.serialization.ObjectSchema<
    serializers.PostV1DevelopersAuthGenerateTokenResponse.Raw,
    OpenLedgerClient.PostV1DevelopersAuthGenerateTokenResponse
...
export declare namespace PostV1DevelopersAuthGenerateTokenResponse {
