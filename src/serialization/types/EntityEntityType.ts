...
export const EntityEntityType: core.serialization.Schema<
    serializers.EntityEntityType.Raw,
    OpenLedgerClient.EntityEntityType
> = core.serialization.enum_(["LLC", "CORPORATION", "PARTNERSHIP", "SOLE_PROPRIETORSHIP", "NON_PROFIT"]);

export declare namespace EntityEntityType {
