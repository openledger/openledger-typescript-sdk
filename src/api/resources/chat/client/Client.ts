...
export class Chat {
     ...
     */
    public async getChatMessages(id: string, chatId: string, requestOptions?: Chat.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
                `api/v1/${encodeURIComponent(id)}/chat/${encodeURIComponent(chatId)}`
            ),
            method: "GET",
            headers: {
     ...
     */
    public async sendAChatMessage(id: string, chatId: string, requestOptions?: Chat.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
