...
export class Accounts {
     ...
     */
    public async getBankAccounts(id: string, requestOptions?: Accounts.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
                `api/v1/${encodeURIComponent(id)}/accounts`
            ),
            method: "GET",
            headers: {
     ...
     */
    public async addABankAccount(id: string, requestOptions?: Accounts.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
     ...
     */
    public async getTotalBalanceOfAllAccounts(id: string, requestOptions?: Accounts.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
                `api/v1/${encodeURIComponent(id)}/accounts/total`
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
