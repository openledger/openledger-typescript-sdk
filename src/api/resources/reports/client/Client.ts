...
export class Reports {
     ...
     */
    public async getProfitAndLossStatement(id: string, requestOptions?: Reports.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
                `api/v1/${encodeURIComponent(id)}/profit-loss`
            ),
            method: "GET",
            headers: {
     ...
     */
    public async generateIncomeStatement(id: string, requestOptions?: Reports.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ??
                    environments.OpenLedgerClientEnvironment.Default,
                `api/v1/${encodeURIComponent(id)}/income-statement`
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
